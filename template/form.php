...
<tr class="form-field">
    ...
    <td>
        ...
        <div id="term__image__wrapper">
            <img id="term_image" src="<?= esc_url($term_image_url) ?>"
        ...
        <p>
            ...
            <a href="#"
               class="button button-secondary tax_media_remove">
...
<tr class="form-field">
    ...
    <td>
        ...
        <img src="<?php echo esc_url($image_url); ?>"
             style="max-width: 100%; height: auto; display: <?php echo $image_url ? 'block' : 'none'; ?>;"
             id="taxonomy_image_preview"/>
        <p>
        <button class="button" id="taxonomy_image_button">
            <?php _e('Upload image', 'wp-term-thumbnail'); ?>
        </button>
        <button class="button" id="taxonomy_image_delete_button">
            <?php _e('Remove image', 'wp-term-thumbnail'); ?>
        </button>
        </p>
    </td>
